...
class Command(BaseCommand):
    def add_arguments(self, parser):
        parser.add_argument(
            "--authors", type=int, default=100, help="Number of authors to create"
        )
        parser.add_argument(
            "--publishers", type=int, default=50, help="Number of publishers to create"
        )
        parser.add_argument(
            "--books", type=int, default=1000, help="Number of books to create"
        )
        parser.add_argument(
            "--sales", type=int, default=5000, help="Number of sales to create"
        )
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            self.stdout.write(
                self.style.SUCCESS(f"Created {num_publishers} publishers.")
            )
